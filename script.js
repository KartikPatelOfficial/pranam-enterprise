...
(function () {
  ...
  const translations = {
    en: {
      ...
      'hero.location': 'Est. 1998 · Ankleshwar, Gujarat',
      'hero.authorised': 'Authorised supplier · Asian Paints PPG',
      ...
      'process.titleHtml': 'From your call to your floor, <em>same day.</em>',
      'process.sub': 'A direct, no-friction supply path between our shelves and your line.',
      'process.s1.title': 'Share your spec',
      'process.s1.desc': 'Drop a message, photo or part number — we match it from stock.',
      'process.s2.title': 'We confirm & quote',
      'process.s2.desc': 'Availability and price within hours — not days.',
      'process.s3.title': 'Same-day despatch',
      'process.s3.desc': 'Picked, packed and on the way across the Bharuch belt.',
      'process.s4.title': 'On your floor',
      'process.s4.desc': 'At your gate before the next shift — every time.',

      'about.eyebrow': 'About',
      'about.factTitle': 'At a glance',
      'about.factBadge': 'Est. 1998',
      ...
      'tile.sealing.label': 'Sealing & glands',
      ...
      'contact.cardTag': 'Industrial supply · Ankleshwar, Gujarat',
      ...
      'form.label': 'Send us your requirement',
      'form.name': 'Your name',
    ...
    hi: {
      ...
      'hero.location': 'स्थापित 1998 · अंकलेश्वर, गुजरात',
      'hero.authorised': 'अधिकृत आपूर्तिकर्ता · Asian Paints PPG',
      ...
      'process.eyebrow': 'हमारी कार्यप्रणाली',
      'process.titleHtml': 'आपकी कॉल से आपकी फ़्लोर तक, <em>उसी दिन।</em>',
      'process.sub': 'हमारी अलमारियों और आपकी लाइन के बीच एक सीधा, बिना अड़चन का आपूर्ति रास्ता।',
      'process.s1.title': 'अपनी स्पेक भेजें',
      'process.s1.desc': 'संदेश, फ़ोटो या पार्ट नंबर भेजें — हम स्टॉक से मिला देंगे।',
      'process.s2.title': 'पुष्टि और कोटेशन',
      'process.s2.desc': 'उपलब्धता और कीमत घंटों में — दिनों में नहीं।',
      'process.s3.title': 'उसी दिन डिस्पैच',
      'process.s3.desc': 'भरूच क्षेत्र में चुना, पैक किया और रवाना।',
      'process.s4.title': 'आपकी फ़्लोर पर',
      'process.s4.desc': 'अगली पाली से पहले आपके गेट पर — हर बार।',

      'about.eyebrow': 'हमारे बारे में',
      'about.factTitle': 'एक नज़र में',
      'about.factBadge': 'स्थापित 1998',
      ...
      'tile.sealing.label': 'सीलिंग और ग्रंथि',
      ...
      'contact.cardTag': 'औद्योगिक आपूर्ति · अंकलेश्वर, गुजरात',
      ...
      'form.label': 'अपनी आवश्यकता भेजें',
      'form.name': 'आपका नाम',
      'form.email': 'ईमेल पता',
    ...
    gu: {
      ...
      'hero.location': 'સ્થાપિત 1998 · અંકલેશ્વર, ગુજરાત',
      'hero.authorised': 'અધિકૃત સપ્લાયર · Asian Paints PPG',
      ...
      'process.eyebrow': 'અમારી કાર્યપદ્ધતિ',
      'process.titleHtml': 'તમારી કૉલથી તમારી ફ્લોર સુધી, <em>એ જ દિવસે.</em>',
      'process.sub': 'અમારી શેલ્ફ અને તમારી લાઇન વચ્ચે સીધો, અડચણ વગરનો સપ્લાય માર્ગ.',
      'process.s1.title': 'તમારી સ્પેક મોકલો',
      'process.s1.desc': 'સંદેશ, ફોટો કે પાર્ટ નંબર મોકલો — અમે સ્ટૉકમાંથી મેચ કરી આપીશું.',
      'process.s2.title': 'પુષ્ટિ અને કોટેશન',
      'process.s2.desc': 'કલાકોમાં ઉપલબ્ધતા અને કિંમત — દિવસોમાં નહીં.',
      'process.s3.title': 'એ જ દિવસે ડિસ્પેચ',
      'process.s3.desc': 'ભરૂચ બેલ્ટમાં પીક કરી, પેક કરી અને માર્ગે.',
      'process.s4.title': 'તમારી ફ્લોર પર',
      'process.s4.desc': 'આગલી શિફ્ટ પહેલા તમારા ગેટ પર — દર વખતે.',

      'about.eyebrow': 'અમારા વિશે',
      'about.factTitle': 'એક નજરમાં',
      'about.factBadge': 'સ્થાપિત 1998',
      ...
      'tile.sealing.label': 'સીલિંગ અને ગ્લેન્ડ',
      ...
      'contact.cardTag': 'ઔદ્યોગિક સપ્લાય · અંકલેશ્વર, ગુજરાત',
      ...
      'form.label': 'તમારી જરૂરિયાત મોકલો',
